...
export default function TopBar({ fullName, company, greeting, unreadCount, highPriorityCount }: TopBarProps) {
  ...
  return (
    <header className="border-b border-white">
      <div className="flex flex-wrap items-start justify-between gap-4 px-4 py-3 lg:px-8">
        <div className="flex shrink-0 items-start gap-3 lg:gap-4">
          <div className="relative flex size-12 shrink-0 items-center justify-center rounded-full border border-white p-3 lg:size-16 lg:p-4">
          ...
          <div className="pt-1">
            <p className="text-lg font-bold text-[#1c2632] lg:text-2xl">{greeting}, {firstName}</p>
            <p className="hidden text-base text-[#1c2632] lg:block">
              You have{' '}
              <HoverCard
                inline
                align="left"
        ...
        <div className="flex shrink-0 flex-col items-end gap-1">
          <div className="flex flex-wrap items-center justify-end gap-2 lg:flex-nowrap lg:gap-4">
            <div className="flex flex-wrap items-center justify-end gap-2 rounded-full p-1 lg:h-12 lg:flex-nowrap lg:p-4">
              <HoverCard
                align="right"
                trigger={
            ...
            <div className="hidden h-12 w-0.5 rounded bg-[#1c2632] opacity-50 lg:block" />
          ...
          <div className="hidden h-px w-full rounded bg-[#1c2632] opacity-50 lg:block" />
      ...
      <div className="scroll-hide flex gap-2 overflow-x-auto px-4 pb-3 lg:hidden">
        {statGroups.map((group) => (
          <StatGroup key={group.key} rows={group.rows} />
        ))}
      </div>
